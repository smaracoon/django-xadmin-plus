...
class AdminDateWidget(forms.DateInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        return mark_safe('<div class="input-group date bootstrap-datepicker"><span class="input-group-addon"><i class="fas fa-calendar-alt"></i></span>%s'
...
class AdminTimeWidget(forms.TimeInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        return mark_safe('<div class="input-group time bootstrap-clockpicker"><span class="input-group-addon"><i class="fas fa-clock">'
...
class AdminSplitDateTime(forms.SplitDateTimeWidget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        # return input_html
        return mark_safe('<div class="datetime clearfix"><div class="input-group date bootstrap-datepicker"><span class="input-group-addon"><i class="fas fa-calendar"></i></span>%s'
                         '<span class="input-group-btn"><button class="btn btn-default" type="button">%s</button></span></div>'
                         '<div class="input-group time bootstrap-clockpicker"><span class="input-group-addon"><i class="fas fa-clock">'
