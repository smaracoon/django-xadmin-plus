...
+function ($) { "use strict";
  ...
  Editpop.prototype.beforeToggle = function() {
    ...
    if(this.content == null){
      var that = this
      $el.find('>i').removeClass('fas fa-edit').addClass('fas fa-spinner fa-spin')
      $.ajax({
        url: $el.data('editable-loadurl'),
        success: function(content){
          $el.find('>i').removeClass('fas fa-spinner fa-spin').addClass('fas fa-edit')
  ...
  Editpop.prototype.setContent = function () {
    ...
    this.$form = $form
    this.$mask = $('<div class="mask"><h2 style="text-align:center;"><i class="fa-spinner fa-spin fas fa-large"></i></h2></div>')
