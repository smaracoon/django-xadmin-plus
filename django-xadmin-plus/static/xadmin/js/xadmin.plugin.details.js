      ...
      click: function(e){
        ...
        if(!modal.length){
          modal = $('<div id="detail-modal-id" class="modal fade detail-modal" role="dialog"><div class="modal-dialog"><div class="modal-content">'+
            ...
            '<a class="btn btn-submit btn-primary edit-btn"><i class="fas fa-pencil-alt"></i> '+gettext('Edit')+'</a></div></div></div></div>');
          $('body').append(modal);
        }
        ...
        modal.find('.modal-body').html('<h1 style="text-align:center;"><i class="fa-spinner fa-spin fas fa-large"></i></h1>');
