...
class BaseWidget(forms.Form):
    ...
    widget_title = None
    widget_icon = 'fas fa-plus-square'
    widget_type = 'base'
    base_title = None
...
class QuickBtnWidget(BaseWidget):
    ...
    widget_icon = 'fas fa-caret-square-right'
...
class ModelDashboard(Dashboard, ModelAdminView):
    ...
    def init_request(self, object_id, *args, **kwargs):
        ...
        if self.has_view_permission() or self.has_view_permission_obj(self.obj):
            pass
        else:
            raise PermissionDenied
    ...
    def get_context(self):
        new_context = {
            'has_change_permission': self.has_change_permission() or self.has_change_permission_obj(self.obj),
            'object': self.obj,
        }
